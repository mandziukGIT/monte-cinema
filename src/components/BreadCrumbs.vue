<template>
  <div class="bread-crumbs">
      <button class="bread-crumbs__back-button" @click="goToPreviousCrumb">Back</button>
      <img class="bread-crumbs__back-arrow" src="@/assets/images/back-arrow-icon.svg" @click="goToPreviousCrumb" />
      <ul class="bread-crumbs__list">
        <li class="bread-crumbs__list--item" v-for="(crumb,index) in routeCrumbs" :key="crumb">
            <router-link :to="routeCrumbs.length - 1 !== index ? { name: crumb } : ''">
                {{ crumb }}
            </router-link>
